            ...
            {clienti.map((c: any) => {
              ...
              return (
                <SchedaLista
                  ...
                  className={isBlocked
                    ? "bg-[#FEF2F2] dark:bg-destructive/10 border-l-[3px] border-l-[#EF4444]"
...
// INFORMATIVA_FULL e CONSENSO_TESTI sono importati da @/lib/consensi-testi
// (fonte unica condivisa con wizard e pagina pubblica /consensi/$token).
