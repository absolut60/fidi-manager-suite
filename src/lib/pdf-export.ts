...
const LOGO_MADE_B64 = "data:image/jpeg;base64,";
...
function drawHeader(doc: jsPDF, titolo: string, prev: PreventivoConDettagli): number {
  ...
  doc.rect(0, 0, w, 26, "F");
  // Logo "sistema MADE" (JPEG inline del preventivatore originale) — 95mm x 20.2mm
