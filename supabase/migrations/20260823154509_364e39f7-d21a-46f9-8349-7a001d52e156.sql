-- FETTA C: notifica assegnazione task + iscrizione esecutore al canale commenti
-- Modellata su notifica_nuovo_messaggio (SECURITY DEFINER, search_path, EXCEPTION non bloccante)
...
BEGIN
  ...
  BEGIN
    -- 1) Iscrivi l'esecutore al canale commenti del task (se non già membro).
    ...
    -- 2) Notifica all'esecutore, ma non a sé stesso.
