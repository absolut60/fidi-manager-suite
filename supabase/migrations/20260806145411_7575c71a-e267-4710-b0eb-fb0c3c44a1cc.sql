ALTER TABLE public.codici_pagamento_giorni
  ADD COLUMN IF NOT EXISTS pagamento_immediato boolean NOT NULL DEFAULT false;

UPDATE public.codici_pagamento_giorni
SET pagamento_immediato = true
WHERE descrizione IN (
  'Rimessa diretta contanti VERCELLI',
  'Rimessa diretta contanti CERIANO',
  'Rimessa diretta contanti CAMBIAGO',
  'Rimessa diretta contanti CASOREZZO',
  'Rimessa diretta contanti PIANEZZA',
  'Rimessa diretta contanti LISSONE',
  'Rimessa diretta contanti AFFORI',
  'Rimessa diretta contanti SAVIGLIANO',
  'Rimessa diretta contanti CINISELLO',
  'Rimessa diretta POS',
  'Rimessa diretta vista fattura contanti',
  'Rimessa diretta assegno CASOREZZO',
  'Rimessa diretta assegno SAVIGLIANO',
  'Rimessa diretta assegno VERCELLI',
  'Rimessa diretta assegno LISSONE',
  'Rimessa diretta assegno CAMBIAGO',
  'Rimessa diretta assegno PIANEZZA',
  'Rimessa diretta vista fattura assegno'
);
...
AS $function$
  SELECT CASE
    ...
    WHEN _fido_base <= 5000 THEN CEIL(_fido_base / 500.0) * 500
