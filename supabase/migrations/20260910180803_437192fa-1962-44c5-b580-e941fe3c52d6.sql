DROP FUNCTION public.registra_consenso_whatsapp(text, text, text, text, text, text, text, text, text, integer, text);

CREATE FUNCTION public.registra_consenso_whatsapp(
  _numero_raw text,
