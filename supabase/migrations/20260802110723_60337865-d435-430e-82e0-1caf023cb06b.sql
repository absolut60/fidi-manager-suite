ALTER TABLE public.consensi_log
  ADD COLUMN IF NOT EXISTS lead_id uuid NULL REFERENCES public.lead(id) ON DELETE SET NULL;

CREATE INDEX IF NOT EXISTS idx_consensi_log_lead_id ON public.consensi_log(lead_id) WHERE lead_id IS NOT NULL;
